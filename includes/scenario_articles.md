        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure 上新闻源的大量引入和分析</h3>
                        <p>创建一个管道，以便仅使用 Azure 服务（包括 Azure Cosmos DB 和 Azure 认知服务）引入和分析文本、图像、情绪以及来自 RSS 新闻源的其他数据。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>适用于基于容器的工作负荷的 CI/CD 管道</h3>
                        <p>使用 Jenkins、Azure 容器注册表、Azure Kubernetes 服务、Cosmos DB 和 Grafana 为 Node.js Web 应用构建 DevOps 管道。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>用于电子商务的智能产品搜索引擎</h3>
                        <p>在电子商务应用程序中提供世界一流的搜索体验。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>在 Azure 上运行 Jenkins 服务器</h3>
                        <p>演示如何在 Azure 上部署和运行使用单一登录 (SSO) 保护的可伸缩企业级 Jenkins 服务器的建议体系结构。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>建筑行业中的 IoT 和数据分析</h3>
                        <p>使用 IoT 设备和数据分析提供建筑项目的全面管理和运营。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>用于销售和市场营销的数据仓库和分析</h3>
                        <p>合并来自多个源的数据并优化数据分析。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>引入和处理实时汽车 IoT 数据</h3>
                        <p>使用 IoT 引入和处理实时车辆数据。</p>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="infrastructure-scenarios"></a>基础结构方案
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>在 Azure 上加快基于数字图像的建模</h3>
                        <p>使用 Avere 和 Agisoft PhotoScan 在 Azure 上加快基于数字图像的建模</p>
                    </div>
                </div>
            </div>
        </div>
