...
通过**数字化转型**迁移到云计算意味着从本地操作方式转变为云操作方式。 这种转变包括以全新方式开展业务 - 例如，数字化转型需要从软件和数据中心硬件的资本开销转变为因使用云资源带来的操作开销。 了解如何开始使用[适用于 Azure 的 Microsoft 云采用框架](../overview.md)。

## <a name="the-digital-transformation-process"></a>数字转换流程
...
## <a name="step-5-translate-existing-roles-skills-and-process-for-the-cloud"></a>步骤 5：针对云来转换现有角色、技能和流程
