...
<span data-ttu-id="c7f38-116">在信任关系中有三个主要角色：</span><span class="sxs-lookup"><span data-stu-id="c7f38-116">There are three main roles in the trust relation:</span></span>
...
## <a name="authentication-flow"></a><span data-ttu-id="c7f38-127">身份验证流</span><span class="sxs-lookup"><span data-stu-id="c7f38-127">Authentication flow</span></span>
...
| <span data-ttu-id="c7f38-161">NameIdentifier</span><span class="sxs-lookup"><span data-stu-id="c7f38-161">nameidentifier</span></span> |<span data-ttu-id="c7f38-162">[名称标识符]。</span><span class="sxs-lookup"><span data-stu-id="c7f38-162">[Name identifier].</span></span> <span data-ttu-id="c7f38-163">为其颁发令牌的实体的名称标识符。</span><span class="sxs-lookup"><span data-stu-id="c7f38-163">The identifier for the name of the entity for which the token was issued.</span></span> |
...
### <a name="edit-claims-rules"></a><span data-ttu-id="c7f38-209">编辑声明规则</span><span class="sxs-lookup"><span data-stu-id="c7f38-209">Edit claims rules</span></span>
1. <span data-ttu-id="c7f38-210">右键单击新添加的声明提供程序信任，然后选择“编辑声明规则”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-210">Right-click the newly added claims provider trust, and select **Edit Claims Rules**.</span></span>
2. <span data-ttu-id="c7f38-211">单击“添加规则”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-211">Click **Add Rule**.</span></span>
3. <span data-ttu-id="c7f38-212">选择"传递或筛选传入声明"，然后单击“下一步”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-212">Select "Pass Through or Filter an Incoming Claim" and click **Next**.</span></span>
   <span data-ttu-id="c7f38-213">![添加转换声明规则向导](./images/edit-claims-rule.png)</span><span class="sxs-lookup"><span data-stu-id="c7f38-213">![Add Transform Claim Rule Wizard](./images/edit-claims-rule.png)</span></span>
4. <span data-ttu-id="c7f38-214">输入规则的名称。</span><span class="sxs-lookup"><span data-stu-id="c7f38-214">Enter a name for the rule.</span></span>
5. <span data-ttu-id="c7f38-215">在“传入声明类型”下选择“UPN”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-215">Under "Incoming claim type", select **UPN**.</span></span>
6. <span data-ttu-id="c7f38-216">选择“传递所有声明值”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-216">Select "Pass through all claim values".</span></span>
   <span data-ttu-id="c7f38-217">![添加转换声明规则向导](./images/edit-claims-rule2.png)</span><span class="sxs-lookup"><span data-stu-id="c7f38-217">![Add Transform Claim Rule Wizard](./images/edit-claims-rule2.png)</span></span>
7. <span data-ttu-id="c7f38-218">单击“完成” 。</span><span class="sxs-lookup"><span data-stu-id="c7f38-218">Click **Finish**.</span></span>
8. <span data-ttu-id="c7f38-219">重复步骤 2 - 7，为传入声明类型指定“定位声明类型”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-219">Repeat steps 2 - 7, and specify **Anchor Claim Type** for the incoming claim type.</span></span>
9. <span data-ttu-id="c7f38-220">单击“确定”完成本向导。</span><span class="sxs-lookup"><span data-stu-id="c7f38-220">Click **OK** to complete the wizard.</span></span>

### <a name="enable-home-realm-discovery"></a><span data-ttu-id="c7f38-221">启用主领域发现</span><span class="sxs-lookup"><span data-stu-id="c7f38-221">Enable home-realm discovery</span></span>
<span data-ttu-id="c7f38-222">运行以下 PowerShell 脚本：</span><span class="sxs-lookup"><span data-stu-id="c7f38-222">Run the following PowerShell script:</span></span>

```
Set-ADFSClaimsProviderTrust -TargetName "name" -OrganizationalAccountSuffix @("suffix")
```

<span data-ttu-id="c7f38-223">其中“name”是声明提供程序信任的友好名称，“suffix”是客户 AD 的 UPN 后缀（例如，“corp.fabrikam.com”）。</span><span class="sxs-lookup"><span data-stu-id="c7f38-223">where "name" is the friendly name of the claims provider trust, and "suffix" is the UPN suffix for the customer's AD (example, "corp.fabrikam.com").</span></span>
...
4. <span data-ttu-id="c7f38-235">在“选择数据源”页上，选择“导入有关联机发布或在本地网络上发布的声明提供程序的数据”选项。</span><span class="sxs-lookup"><span data-stu-id="c7f38-235">On the **Select Data Source** page, select the option "Import data about the claims provider published online or on a local network".</span></span> <span data-ttu-id="c7f38-236">输入 SaaS 提供程序的联合身份验证元数据终结点的 URI。</span><span class="sxs-lookup"><span data-stu-id="c7f38-236">Enter the URI of the SaaS provider's federation metadata endpoint.</span></span>
   <span data-ttu-id="c7f38-237">![添加信赖方信任向导](./images/add-rp-trust.png)</span><span class="sxs-lookup"><span data-stu-id="c7f38-237">![Add Relying Party Trust Wizard](./images/add-rp-trust.png)</span></span>
...
6. <span data-ttu-id="c7f38-239">在“选择访问控制策略”页上选择一项策略。</span><span class="sxs-lookup"><span data-stu-id="c7f38-239">On the **Choose Access Control Policy** page, choose a policy.</span></span> <span data-ttu-id="c7f38-240">可以允许组织中的每个人，也可选择特定安全组。</span><span class="sxs-lookup"><span data-stu-id="c7f38-240">You could permit everyone in the organization, or choose a specific security group.</span></span>
   <span data-ttu-id="c7f38-241">![添加信赖方信任向导](./images/add-rp-trust2.png)</span><span class="sxs-lookup"><span data-stu-id="c7f38-241">![Add Relying Party Trust Wizard](./images/add-rp-trust2.png)</span></span>
7. <span data-ttu-id="c7f38-242">在“策略”框中输入所需的任何参数。</span><span class="sxs-lookup"><span data-stu-id="c7f38-242">Enter any parameters required in the **Policy** box.</span></span>
8. <span data-ttu-id="c7f38-243">单击“下一步”按钮完成向导。</span><span class="sxs-lookup"><span data-stu-id="c7f38-243">Click **Next** to complete the wizard.</span></span>

### <a name="add-claims-rules"></a><span data-ttu-id="c7f38-244">添加声明规则</span><span class="sxs-lookup"><span data-stu-id="c7f38-244">Add claims rules</span></span>
1. <span data-ttu-id="c7f38-245">右键单击新添加的信赖方信任，然后选择“编辑声明颁发策略”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-245">Right-click the newly added relying party trust, and select **Edit Claim Issuance Policy**.</span></span>
2. <span data-ttu-id="c7f38-246">单击“添加规则”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-246">Click **Add Rule**.</span></span>
3. <span data-ttu-id="c7f38-247">选择“以声明方式发送 LDAP 属性”，然后单击“下一步”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-247">Select "Send LDAP Attributes as Claims" and click **Next**.</span></span>
4. <span data-ttu-id="c7f38-248">输入规则的名称，如“UPN”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-248">Enter a name for the rule, such as "UPN".</span></span>
5. <span data-ttu-id="c7f38-249">在“属性存储”下，选择“Active Directory”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-249">Under **Attribute store**, select **Active Directory**.</span></span>
   <span data-ttu-id="c7f38-250">![添加转换声明规则向导](./images/add-claims-rules.png)</span><span class="sxs-lookup"><span data-stu-id="c7f38-250">![Add Transform Claim Rule Wizard](./images/add-claims-rules.png)</span></span>
6. <span data-ttu-id="c7f38-251">在“LDAP 属性的映射”部分中：</span><span class="sxs-lookup"><span data-stu-id="c7f38-251">In the **Mapping of LDAP attributes** section:</span></span>
   ...
   * <span data-ttu-id="c7f38-253">在"传出声明类型"下选择“UPN”。</span><span class="sxs-lookup"><span data-stu-id="c7f38-253">Under **Outgoing Claim Type**, select **UPN**.</span></span>
     <span data-ttu-id="c7f38-254">![添加转换声明规则向导](./images/add-claims-rules2.png)</span><span class="sxs-lookup"><span data-stu-id="c7f38-254">![Add Transform Claim Rule Wizard](./images/add-claims-rules2.png)</span></span>
