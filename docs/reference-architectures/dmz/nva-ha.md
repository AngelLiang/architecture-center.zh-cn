...
> [!NOTE]
> 此体系结构用于 [Azure 与本地数据中心之间的外围网络][dmz-on-premises]参考体系结构和 [Azure 与 Internet 之间的外围网络][dmz-internet]参考体系结构中。 这些参考体系结构每个都包括你可以使用的部署解决方案。 有关详细信息，请参阅以下链接。
...
- 了解如何使用第 7 层 NVA [在 Azure 与本地数据中心之间实现外围网络][dmz-on-premises]。
