...
## <a name="availability-considerations---traffic-manager"></a>可用性注意事项 - 流量管理器
...
## <a name="availability-considerations---sql-database"></a>可用性注意事项 - SQL 数据库

[使用 Azure SQL 数据库确保业务连续性的相关概述][sql-rpo]中介绍了 SQL 数据库的恢复点目标 (RPO) 和估计恢复时间 (ERT)。

## <a name="availability-considerations---storage"></a>可用性注意事项 - 存储
...
## <a name="manageability-considerations---traffic-manager"></a>可管理性注意事项 - 流量管理器
...
## <a name="manageability-considerations---sql-database"></a>可管理性注意事项 - SQL 数据库
