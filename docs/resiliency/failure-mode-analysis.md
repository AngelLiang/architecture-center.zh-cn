...
<span data-ttu-id="c8c1c-121">作为 FMA 过程的起点，本文包含了潜在故障模式及其缓解措施的目录。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-121">As a starting point for your FMA process, this article contains a catalog of potential failure modes and their mitigations.</span></span> <span data-ttu-id="c8c1c-122">该目录按技术或 Azure 服务分类，另外还有一个针对应用程序级设计的常规目录。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-122">The catalog is organized by technology or Azure service, plus a general category for application-level design.</span></span> <span data-ttu-id="c8c1c-123">该目录并不详尽，但涵盖许多核心 Azure 服务。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-123">The catalog is not exhaustive, but covers many of the core Azure services.</span></span>
...
* <span data-ttu-id="c8c1c-145">如果应用崩溃或应用服务 VM 变得不可用，应用服务会自动重启应用。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-145">If the app crashes or an App Service VM becomes unavailable, App Service automatically restarts the app.</span></span>
...
## <a name="azure-active-directory"></a><span data-ttu-id="c8c1c-164">Azure Active Directory</span><span class="sxs-lookup"><span data-stu-id="c8c1c-164">Azure Active Directory</span></span>
...
<span data-ttu-id="c8c1c-183">**恢复**</span><span class="sxs-lookup"><span data-stu-id="c8c1c-183">**Recovery**</span></span>
...
<span data-ttu-id="c8c1c-204">**检测**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-204">**Detection**.</span></span> <span data-ttu-id="c8c1c-205">捕获异常。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-205">Catch the exception.</span></span> <span data-ttu-id="c8c1c-206">对于 .NET 客户端，通常为 `System.Web.HttpException`。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-206">For .NET clients, this will typically be `System.Web.HttpException`.</span></span> <span data-ttu-id="c8c1c-207">其他客户端可能有其他异常类型。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-207">Other client may have other exception types.</span></span>  <span data-ttu-id="c8c1c-208">有关详细信息，请参阅 [Cassandra error handling done right](https://www.datastax.com/dev/blog/cassandra-error-handling-done-right)（正确的 Cassandra 错误处理）。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-208">For more information, see [Cassandra error handling done right](https://www.datastax.com/dev/blog/cassandra-error-handling-done-right).</span></span>
...
## <a name="cosmos-db"></a><span data-ttu-id="c8c1c-224">Cosmos DB</span><span class="sxs-lookup"><span data-stu-id="c8c1c-224">Cosmos DB</span></span> 
...
### <a name="writing-data-fails"></a><span data-ttu-id="c8c1c-245">写入数据失败。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-245">Writing data fails.</span></span>
...
<span data-ttu-id="c8c1c-268">**恢复**</span><span class="sxs-lookup"><span data-stu-id="c8c1c-268">**Recovery**</span></span>
...
<span data-ttu-id="c8c1c-291">**恢复**</span><span class="sxs-lookup"><span data-stu-id="c8c1c-291">**Recovery**</span></span>
...
<span data-ttu-id="c8c1c-312">**恢复**</span><span class="sxs-lookup"><span data-stu-id="c8c1c-312">**Recovery**</span></span>
...
<span data-ttu-id="c8c1c-331">**恢复**</span><span class="sxs-lookup"><span data-stu-id="c8c1c-331">**Recovery**</span></span>
...
### <a name="writing-a-message-to-a-service-bus-queue-fails"></a><span data-ttu-id="c8c1c-376">向服务总线队列写入消息失败。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-376">Writing a message to a Service Bus queue fails.</span></span>
...
<span data-ttu-id="c8c1c-419">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-419">**Diagnostics**.</span></span> <span data-ttu-id="c8c1c-420">记录重复消息。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-420">Log duplicated messages.</span></span>
...
<span data-ttu-id="c8c1c-441">**恢复**</span><span class="sxs-lookup"><span data-stu-id="c8c1c-441">**Recovery**</span></span>
...
<span data-ttu-id="c8c1c-464">**恢复**</span><span class="sxs-lookup"><span data-stu-id="c8c1c-464">**Recovery**</span></span>
...
<span data-ttu-id="c8c1c-485">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-485">**Diagnostics**.</span></span> <span data-ttu-id="c8c1c-486">使用[存储度量值][storage-metrics]。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-486">Use [storage metrics][storage-metrics].</span></span>
...
<span data-ttu-id="c8c1c-498">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-498">**Diagnostics**.</span></span> <span data-ttu-id="c8c1c-499">记录服务边界的事件。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-499">Log events at service boundaries.</span></span>

### <a name="vm-instance-becomes-unavailable-or-unhealthy"></a><span data-ttu-id="c8c1c-500">VM 实例变得不可用或不正常。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-500">VM instance becomes unavailable or unhealthy.</span></span>
<span data-ttu-id="c8c1c-501">**检测**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-501">**Detection**.</span></span> <span data-ttu-id="c8c1c-502">配置负载均衡器[运行状况探测][lb-probe]，以便发信号指示 VM 实例是否正常。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-502">Configure a Load Balancer [health probe][lb-probe] that signals whether the VM instance is healthy.</span></span> <span data-ttu-id="c8c1c-503">探测应检查关键功能能否正确响应。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-503">The probe should check whether critical functions are responding correctly.</span></span>

<span data-ttu-id="c8c1c-504">**恢复**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-504">**Recovery**.</span></span> <span data-ttu-id="c8c1c-505">对于每个应用程序层，将多个 VM 实例放入同一可用性集中，并在 VM 前面放一个负载均衡器。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-505">For each application tier, put multiple VM instances into the same availability set, and place a load balancer in front of the VMs.</span></span> <span data-ttu-id="c8c1c-506">如果运行状况探测失败，负载均衡器会停止向不正常的实例发送新连接。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-506">If the health probe fails, the Load Balancer stops sending new connections to the unhealthy instance.</span></span>

<span data-ttu-id="c8c1c-507">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-507">**Diagnostics**.</span></span> <span data-ttu-id="c8c1c-508">- 使用负载均衡器 [Log Analytics][lb-monitor]。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-508">- Use Load Balancer [log analytics][lb-monitor].</span></span>

* <span data-ttu-id="c8c1c-509">配置监视系统，以监视所有运行状况监视终结点。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-509">Configure your monitoring system to monitor all of the health monitoring endpoints.</span></span>

### <a name="operator-accidentally-shuts-down-a-vm"></a><span data-ttu-id="c8c1c-510">操作员意外关闭 VM。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-510">Operator accidentally shuts down a VM.</span></span>
<span data-ttu-id="c8c1c-511">**检测**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-511">**Detection**.</span></span> <span data-ttu-id="c8c1c-512">不适用</span><span class="sxs-lookup"><span data-stu-id="c8c1c-512">N/A</span></span>

<span data-ttu-id="c8c1c-513">**恢复**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-513">**Recovery**.</span></span> <span data-ttu-id="c8c1c-514">设置 `ReadOnly` 级别的资源锁。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-514">Set a resource lock with `ReadOnly` level.</span></span> <span data-ttu-id="c8c1c-515">请参阅[使用 Azure 资源管理器锁定资源][rm-locks]。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-515">See [Lock resources with Azure Resource Manager][rm-locks].</span></span>

<span data-ttu-id="c8c1c-516">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-516">**Diagnostics**.</span></span> <span data-ttu-id="c8c1c-517">使用 [Azure 活动日志][azure-activity-logs]。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-517">Use [Azure Activity Logs][azure-activity-logs].</span></span>

## <a name="webjobs"></a><span data-ttu-id="c8c1c-518">Web 作业</span><span class="sxs-lookup"><span data-stu-id="c8c1c-518">WebJobs</span></span>
### <a name="continuous-job-stops-running-when-the-scm-host-is-idle"></a><span data-ttu-id="c8c1c-519">SCM 主机闲置时，连续作业停止运行。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-519">Continuous job stops running when the SCM host is idle.</span></span>
<span data-ttu-id="c8c1c-520">**检测**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-520">**Detection**.</span></span> <span data-ttu-id="c8c1c-521">向 WebJob 函数传递一个取消标记。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-521">Pass a cancellation token to the WebJob function.</span></span> <span data-ttu-id="c8c1c-522">有关详细信息，请参阅[正常关闭][web-jobs-shutdown]。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-522">For more information, see [Graceful shutdown][web-jobs-shutdown].</span></span>

<span data-ttu-id="c8c1c-523">**恢复**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-523">**Recovery**.</span></span> <span data-ttu-id="c8c1c-524">在 Web 应用中启用 `Always On` 设置。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-524">Enable the `Always On` setting in the web app.</span></span> <span data-ttu-id="c8c1c-525">有关详细信息，请参阅[使用 WebJobs 运行后台任务][web-jobs]。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-525">For more information, see [Run Background tasks with WebJobs][web-jobs].</span></span>

## <a name="application-design"></a><span data-ttu-id="c8c1c-526">应用程序设计</span><span class="sxs-lookup"><span data-stu-id="c8c1c-526">Application design</span></span>
### <a name="application-cant-handle-a-spike-in-incoming-requests"></a><span data-ttu-id="c8c1c-527">应用程序无法处理陡增的传入请求。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-527">Application can't handle a spike in incoming requests.</span></span>
<span data-ttu-id="c8c1c-528">**检测**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-528">**Detection**.</span></span> <span data-ttu-id="c8c1c-529">取决于应用程序。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-529">Depends on the application.</span></span> <span data-ttu-id="c8c1c-530">典型症状：</span><span class="sxs-lookup"><span data-stu-id="c8c1c-530">Typical symptoms:</span></span>

* <span data-ttu-id="c8c1c-531">网站开始返回 HTTP 5xx 错误代码。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-531">The website starts returning HTTP 5xx error codes.</span></span>
* <span data-ttu-id="c8c1c-532">从属服务（比如数据库或存储）开始限制请求。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-532">Dependent services, such as database or storage, start to throttle requests.</span></span> <span data-ttu-id="c8c1c-533">请查找 HTTP 错误，比如 HTTP 429（请求过多），具体视服务而定。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-533">Look for HTTP errors such as HTTP 429 (Too Many Requests), depending on the service.</span></span>
* <span data-ttu-id="c8c1c-534">HTTP 队列长度变长。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-534">HTTP queue length grows.</span></span>

<span data-ttu-id="c8c1c-535">**恢复**</span><span class="sxs-lookup"><span data-stu-id="c8c1c-535">**Recovery**</span></span>

* <span data-ttu-id="c8c1c-536">横向扩展以处理增加的负载。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-536">Scale out to handle increased load.</span></span>
* <span data-ttu-id="c8c1c-537">缓解故障影响，避免让级联故障中断整个应用程序。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-537">Mitigate failures to avoid having cascading failures disrupt the entire application.</span></span> <span data-ttu-id="c8c1c-538">缓解策略包括：</span><span class="sxs-lookup"><span data-stu-id="c8c1c-538">Mitigation strategies include:</span></span>

  * <span data-ttu-id="c8c1c-539">实施[限制模式][throttling-pattern]，以免后端系统瘫痪。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-539">Implement the [Throttling Pattern][throttling-pattern] to avoid overwhelming backend systems.</span></span>
  * <span data-ttu-id="c8c1c-540">使用[基于队列的负载调节][queue-based-load-leveling]缓冲请求，并以适当的节奏处理它们。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-540">Use [queue-based load leveling][queue-based-load-leveling] to buffer requests and process them at an appropriate pace.</span></span>
  * <span data-ttu-id="c8c1c-541">优先某些客户端。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-541">Prioritize certain clients.</span></span> <span data-ttu-id="c8c1c-542">例如，如果应用程序具有免费层和付费层，则限制免费层的客户，而不是付费客户。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-542">For example, if the application has free and paid tiers, throttle customers on the free tier, but not paid customers.</span></span> <span data-ttu-id="c8c1c-543">请参阅[优先级队列模式][priority-queue-pattern]。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-543">See [Priority queue pattern][priority-queue-pattern].</span></span>

<span data-ttu-id="c8c1c-544">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-544">**Diagnostics**.</span></span> <span data-ttu-id="c8c1c-545">使用[应用服务诊断日志记录][app-service-logging]。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-545">Use [App Service diagnostic logging][app-service-logging].</span></span> <span data-ttu-id="c8c1c-546">使用 [Azure Log Analytics][azure-log-analytics]、[Application Insights][app-insights] 或 [New Relic][new-relic] 等服务帮助了解诊断日志。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-546">Use a service such as [Azure Log Analytics][azure-log-analytics], [Application Insights][app-insights], or [New Relic][new-relic] to help understand the diagnostic logs.</span></span>

### <a name="one-of-the-operations-in-a-workflow-or-distributed-transaction-fails"></a><span data-ttu-id="c8c1c-547">工作流或分布式事务中的某个操作失败。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-547">One of the operations in a workflow or distributed transaction fails.</span></span>
<span data-ttu-id="c8c1c-548">**检测**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-548">**Detection**.</span></span> <span data-ttu-id="c8c1c-549">尝试 *N* 次重试后仍然失败。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-549">After *N* retry attempts, it still fails.</span></span>

<span data-ttu-id="c8c1c-550">**恢复**</span><span class="sxs-lookup"><span data-stu-id="c8c1c-550">**Recovery**</span></span>

* <span data-ttu-id="c8c1c-551">作为缓解计划，可实施[计划程序代理监督程序][scheduler-agent-supervisor]模式来管理整个工作流。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-551">As a mitigation plan, implement the [Scheduler Agent Supervisor][scheduler-agent-supervisor] pattern to manage the entire workflow.</span></span>
* <span data-ttu-id="c8c1c-552">对于超时错误，不要重试。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-552">Don't retry on timeouts.</span></span> <span data-ttu-id="c8c1c-553">此错误的成功率较低。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-553">There is a low success rate for this error.</span></span>
* <span data-ttu-id="c8c1c-554">将工作排队，以便稍后重试。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-554">Queue work, in order to retry later.</span></span>

<span data-ttu-id="c8c1c-555">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-555">**Diagnostics**.</span></span> <span data-ttu-id="c8c1c-556">记录所有操作（成功的和失败的），包括补偿操作。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-556">Log all operations (successful and failed), including compensating actions.</span></span> <span data-ttu-id="c8c1c-557">使用关联 ID，以便跟踪同一事务内的所有操作。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-557">Use correlation IDs, so that you can track all operations within the same transaction.</span></span>

### <a name="a-call-to-a-remote-service-fails"></a><span data-ttu-id="c8c1c-558">对远程服务的调用失败。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-558">A call to a remote service fails.</span></span>
<span data-ttu-id="c8c1c-559">**检测**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-559">**Detection**.</span></span> <span data-ttu-id="c8c1c-560">HTTP 错误代码。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-560">HTTP error code.</span></span>

<span data-ttu-id="c8c1c-561">**恢复**</span><span class="sxs-lookup"><span data-stu-id="c8c1c-561">**Recovery**</span></span>

1. <span data-ttu-id="c8c1c-562">对暂时性故障进行重试。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-562">Retry on transient failures.</span></span>
2. <span data-ttu-id="c8c1c-563">如果尝试 *N* 次后，调用仍失败，则执行回退操作。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-563">If the call fails after *N* attempts, take a fallback action.</span></span> <span data-ttu-id="c8c1c-564">（特定于应用程序。）</span><span class="sxs-lookup"><span data-stu-id="c8c1c-564">(Application specific.)</span></span>
3. <span data-ttu-id="c8c1c-565">实施[断路器模式][circuit-breaker]以免出现级联故障。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-565">Implement the [Circuit Breaker pattern][circuit-breaker] to avoid cascading failures.</span></span>

<span data-ttu-id="c8c1c-566">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-566">**Diagnostics**.</span></span> <span data-ttu-id="c8c1c-567">记录所有远程调用失败。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-567">Log all remote call failures.</span></span>

## <a name="next-steps"></a><span data-ttu-id="c8c1c-568">后续步骤</span><span class="sxs-lookup"><span data-stu-id="c8c1c-568">Next steps</span></span>
<span data-ttu-id="c8c1c-569">有关 FMA 过程的详细信息，请参阅[专为云服务设计的复原能力][resilience-by-design-pdf]（PDF 下载）。</span><span class="sxs-lookup"><span data-stu-id="c8c1c-569">For more information about the FMA process, see [Resilience by design for cloud services][resilience-by-design-pdf] (PDF download).</span></span>
