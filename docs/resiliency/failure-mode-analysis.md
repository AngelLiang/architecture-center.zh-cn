...
### <a name="a-bad-update-was-deployed"></a><span data-ttu-id="2c7cc-158">部署了错误的更新。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-158">A bad update was deployed.</span></span>
...
## <a name="azure-search"></a><span data-ttu-id="2c7cc-179">Azure 搜索</span><span class="sxs-lookup"><span data-stu-id="2c7cc-179">Azure Search</span></span>
...
## <a name="cloud-service"></a><span data-ttu-id="2c7cc-217">云服务</span><span class="sxs-lookup"><span data-stu-id="2c7cc-217">Cloud Service</span></span>
...
<span data-ttu-id="2c7cc-262">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-262">**Diagnostics**.</span></span> <span data-ttu-id="2c7cc-263">记录客户端上的所有错误。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-263">Log all errors on the client side.</span></span>
...
- <span data-ttu-id="2c7cc-280">使用重试机制。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-280">Use a retry mechanism.</span></span> <span data-ttu-id="2c7cc-281">每个客户端都有自己的重试策略。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-281">Each client has its own retry policies.</span></span>
...
<span data-ttu-id="2c7cc-316">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-316">**Diagnostics**.</span></span> <span data-ttu-id="2c7cc-317">使用 [Redis 缓存诊断][redis-monitor]。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-317">Use [Redis Cache diagnostics][redis-monitor].</span></span>
...
- <span data-ttu-id="2c7cc-334">对于查询，请从次要副本中读取。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-334">For queries, read from a secondary replica.</span></span>
...
### <a name="writing-a-message-to-a-service-bus-queue-fails"></a><span data-ttu-id="2c7cc-376">向服务总线队列写入消息失败。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-376">Writing a message to a Service Bus queue fails.</span></span>
...
<span data-ttu-id="2c7cc-419">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-419">**Diagnostics**.</span></span> <span data-ttu-id="2c7cc-420">记录重复消息。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-420">Log duplicated messages.</span></span>
...
<span data-ttu-id="2c7cc-439">**检测**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-439">**Detection**.</span></span> <span data-ttu-id="2c7cc-440">服务返回一个错误。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-440">The service returns an error.</span></span>
...
### <a name="writing-data-to-azure-storage-fails"></a><span data-ttu-id="2c7cc-461">向 Azure 存储写入数据失败</span><span class="sxs-lookup"><span data-stu-id="2c7cc-461">Writing data to Azure Storage fails</span></span>
...
<span data-ttu-id="2c7cc-485">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-485">**Diagnostics**.</span></span> <span data-ttu-id="2c7cc-486">使用[存储度量值][storage-metrics]。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-486">Use [storage metrics][storage-metrics].</span></span>
...
<span data-ttu-id="2c7cc-507">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-507">**Diagnostics**.</span></span> <span data-ttu-id="2c7cc-508">- 使用负载均衡器[日志分析][lb-monitor]。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-508">- Use Load Balancer [log analytics][lb-monitor].</span></span>

- <span data-ttu-id="2c7cc-509">配置监视系统，以监视所有运行状况监视终结点。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-509">Configure your monitoring system to monitor all of the health monitoring endpoints.</span></span>

### <a name="operator-accidentally-shuts-down-a-vm"></a><span data-ttu-id="2c7cc-510">操作员意外关闭 VM。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-510">Operator accidentally shuts down a VM.</span></span>

<span data-ttu-id="2c7cc-511">**检测**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-511">**Detection**.</span></span> <span data-ttu-id="2c7cc-512">不适用</span><span class="sxs-lookup"><span data-stu-id="2c7cc-512">N/A</span></span>

<span data-ttu-id="2c7cc-513">**恢复**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-513">**Recovery**.</span></span> <span data-ttu-id="2c7cc-514">设置 `ReadOnly` 级别的资源锁。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-514">Set a resource lock with `ReadOnly` level.</span></span> <span data-ttu-id="2c7cc-515">请参阅[使用 Azure 资源管理器锁定资源][rm-locks]。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-515">See [Lock resources with Azure Resource Manager][rm-locks].</span></span>

<span data-ttu-id="2c7cc-516">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-516">**Diagnostics**.</span></span> <span data-ttu-id="2c7cc-517">使用 [Azure 活动日志][azure-activity-logs]。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-517">Use [Azure Activity Logs][azure-activity-logs].</span></span>

## <a name="webjobs"></a><span data-ttu-id="2c7cc-518">Web 作业</span><span class="sxs-lookup"><span data-stu-id="2c7cc-518">WebJobs</span></span>

### <a name="continuous-job-stops-running-when-the-scm-host-is-idle"></a><span data-ttu-id="2c7cc-519">SCM 主机闲置时，连续作业停止运行。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-519">Continuous job stops running when the SCM host is idle.</span></span>

<span data-ttu-id="2c7cc-520">**检测**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-520">**Detection**.</span></span> <span data-ttu-id="2c7cc-521">向 WebJob 函数传递一个取消标记。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-521">Pass a cancellation token to the WebJob function.</span></span> <span data-ttu-id="2c7cc-522">有关详细信息，请参阅[正常关闭][web-jobs-shutdown]。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-522">For more information, see [Graceful shutdown][web-jobs-shutdown].</span></span>

<span data-ttu-id="2c7cc-523">**恢复**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-523">**Recovery**.</span></span> <span data-ttu-id="2c7cc-524">在 Web 应用中启用 `Always On` 设置。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-524">Enable the `Always On` setting in the web app.</span></span> <span data-ttu-id="2c7cc-525">有关详细信息，请参阅[使用 WebJobs 运行后台任务][web-jobs]。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-525">For more information, see [Run Background tasks with WebJobs][web-jobs].</span></span>

## <a name="application-design"></a><span data-ttu-id="2c7cc-526">应用程序设计</span><span class="sxs-lookup"><span data-stu-id="2c7cc-526">Application design</span></span>

### <a name="application-cant-handle-a-spike-in-incoming-requests"></a><span data-ttu-id="2c7cc-527">应用程序无法处理陡增的传入请求。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-527">Application can't handle a spike in incoming requests.</span></span>

<span data-ttu-id="2c7cc-528">**检测**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-528">**Detection**.</span></span> <span data-ttu-id="2c7cc-529">取决于应用程序。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-529">Depends on the application.</span></span> <span data-ttu-id="2c7cc-530">典型症状：</span><span class="sxs-lookup"><span data-stu-id="2c7cc-530">Typical symptoms:</span></span>

- <span data-ttu-id="2c7cc-531">网站开始返回 HTTP 5xx 错误代码。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-531">The website starts returning HTTP 5xx error codes.</span></span>
- <span data-ttu-id="2c7cc-532">从属服务（比如数据库或存储）开始限制请求。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-532">Dependent services, such as database or storage, start to throttle requests.</span></span> <span data-ttu-id="2c7cc-533">请查找 HTTP 错误，比如 HTTP 429（请求过多），具体视服务而定。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-533">Look for HTTP errors such as HTTP 429 (Too Many Requests), depending on the service.</span></span>
- <span data-ttu-id="2c7cc-534">HTTP 队列长度变长。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-534">HTTP queue length grows.</span></span>

<span data-ttu-id="2c7cc-535">**恢复：**</span><span class="sxs-lookup"><span data-stu-id="2c7cc-535">**Recovery:**</span></span>

- <span data-ttu-id="2c7cc-536">横向扩展以处理增加的负载。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-536">Scale out to handle increased load.</span></span>
- <span data-ttu-id="2c7cc-537">缓解故障影响，避免让级联故障中断整个应用程序。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-537">Mitigate failures to avoid having cascading failures disrupt the entire application.</span></span> <span data-ttu-id="2c7cc-538">缓解策略包括：</span><span class="sxs-lookup"><span data-stu-id="2c7cc-538">Mitigation strategies include:</span></span>

  - <span data-ttu-id="2c7cc-539">实施[限制模式][throttling-pattern]，以免后端系统瘫痪。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-539">Implement the [Throttling pattern][throttling-pattern] to avoid overwhelming backend systems.</span></span>
  - <span data-ttu-id="2c7cc-540">使用[基于队列的负载调节][queue-based-load-leveling]缓冲请求，并以适当的节奏处理它们。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-540">Use [queue-based load leveling][queue-based-load-leveling] to buffer requests and process them at an appropriate pace.</span></span>
  - <span data-ttu-id="2c7cc-541">优先某些客户端。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-541">Prioritize certain clients.</span></span> <span data-ttu-id="2c7cc-542">例如，如果应用程序具有免费层和付费层，则限制免费层的客户，而不是付费客户。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-542">For example, if the application has free and paid tiers, throttle customers on the free tier, but not paid customers.</span></span> <span data-ttu-id="2c7cc-543">请参阅[优先级队列模式][priority-queue-pattern]。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-543">See [Priority queue pattern][priority-queue-pattern].</span></span>

<span data-ttu-id="2c7cc-544">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-544">**Diagnostics**.</span></span> <span data-ttu-id="2c7cc-545">使用[应用服务诊断日志记录][app-service-logging]。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-545">Use [App Service diagnostic logging][app-service-logging].</span></span> <span data-ttu-id="2c7cc-546">使用 [Azure Log Analytics][azure-log-analytics]、[Application Insights][app-insights] 或 [New Relic][new-relic] 等服务帮助了解诊断日志。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-546">Use a service such as [Azure Log Analytics][azure-log-analytics], [Application Insights][app-insights], or [New Relic][new-relic] to help understand the diagnostic logs.</span></span>

### <a name="one-of-the-operations-in-a-workflow-or-distributed-transaction-fails"></a><span data-ttu-id="2c7cc-547">工作流或分布式事务中的某个操作失败。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-547">One of the operations in a workflow or distributed transaction fails.</span></span>

<span data-ttu-id="2c7cc-548">**检测**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-548">**Detection**.</span></span> <span data-ttu-id="2c7cc-549">尝试 *N* 次重试后仍然失败。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-549">After *N* retry attempts, it still fails.</span></span>

<span data-ttu-id="2c7cc-550">**恢复：**</span><span class="sxs-lookup"><span data-stu-id="2c7cc-550">**Recovery:**</span></span>

- <span data-ttu-id="2c7cc-551">作为缓解计划，可实施[计划程序代理监督程序][scheduler-agent-supervisor]模式来管理整个工作流。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-551">As a mitigation plan, implement the [Scheduler Agent Supervisor][scheduler-agent-supervisor] pattern to manage the entire workflow.</span></span>
- <span data-ttu-id="2c7cc-552">对于超时错误，不要重试。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-552">Don't retry on timeouts.</span></span> <span data-ttu-id="2c7cc-553">此错误的成功率较低。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-553">There is a low success rate for this error.</span></span>
- <span data-ttu-id="2c7cc-554">将工作排队，以便稍后重试。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-554">Queue work, in order to retry later.</span></span>

<span data-ttu-id="2c7cc-555">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-555">**Diagnostics**.</span></span> <span data-ttu-id="2c7cc-556">记录所有操作（成功的和失败的），包括补偿操作。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-556">Log all operations (successful and failed), including compensating actions.</span></span> <span data-ttu-id="2c7cc-557">使用关联 ID，以便跟踪同一事务内的所有操作。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-557">Use correlation IDs, so that you can track all operations within the same transaction.</span></span>

### <a name="a-call-to-a-remote-service-fails"></a><span data-ttu-id="2c7cc-558">对远程服务的调用失败。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-558">A call to a remote service fails.</span></span>

<span data-ttu-id="2c7cc-559">**检测**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-559">**Detection**.</span></span> <span data-ttu-id="2c7cc-560">HTTP 错误代码。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-560">HTTP error code.</span></span>

<span data-ttu-id="2c7cc-561">**恢复：**</span><span class="sxs-lookup"><span data-stu-id="2c7cc-561">**Recovery:**</span></span>

1. <span data-ttu-id="2c7cc-562">对暂时性故障进行重试。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-562">Retry on transient failures.</span></span>
2. <span data-ttu-id="2c7cc-563">如果尝试 *N* 次后，调用仍失败，则执行回退操作。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-563">If the call fails after *N* attempts, take a fallback action.</span></span> <span data-ttu-id="2c7cc-564">（特定于应用程序。）</span><span class="sxs-lookup"><span data-stu-id="2c7cc-564">(Application specific.)</span></span>
3. <span data-ttu-id="2c7cc-565">实施[断路器模式][circuit-breaker]以免出现级联故障。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-565">Implement the [Circuit Breaker pattern][circuit-breaker] to avoid cascading failures.</span></span>

<span data-ttu-id="2c7cc-566">**诊断**。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-566">**Diagnostics**.</span></span> <span data-ttu-id="2c7cc-567">记录所有远程调用失败。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-567">Log all remote call failures.</span></span>

## <a name="next-steps"></a><span data-ttu-id="2c7cc-568">后续步骤</span><span class="sxs-lookup"><span data-stu-id="2c7cc-568">Next steps</span></span>

<span data-ttu-id="2c7cc-569">有关 FMA 过程的详细信息，请参阅[专为云服务设计的复原能力][resilience-by-design-pdf]（PDF 下载）。</span><span class="sxs-lookup"><span data-stu-id="2c7cc-569">For more information about the FMA process, see [Resilience by design for cloud services][resilience-by-design-pdf] (PDF download).</span></span>
